...
```{r diagram_data_within_match}

resources <- c("competitions","fixtures","textstream")
info_obtained <- c("season ids","match ids","events and game info")

diagram_data_within_match <- create_linear_resources_diagram(resources, info_obtained)
render_diagram_as_tree(diagram_data_within_match)
...
Data is saved in groups of 10 matches to avoid memory issues.

```{r get_data_within_match}
